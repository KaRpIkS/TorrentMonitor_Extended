...
class Database
{
    ...
    {
        $result = "";
        $stmt = self::newStatement("SELECT `value` FROM `pluginsettings` WHERE `type` = :type AND `group` = :group AND `key` = :setting");
    ...
    {
        $result = FALSE;
        $stmt = self::newStatement("DELETE FROM `pluginsettings` WHERE `type` = :type AND `group` = :group");
